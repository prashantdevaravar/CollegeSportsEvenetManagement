...
<head>
<style type="text/css">
	body {background-image:url(download2.png); background-size:cover;background-position:center center;position:relative;top:0;bottom:0;height:100vh;z-index:-10;}
...
$query="SELECT Sid,Sportsname,Location,Date,Time,First,Second FROM spdetail1 WHERE Sportsname='Hockey'";
